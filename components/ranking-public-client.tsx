...
import { RankIcon, StreakDisplay } from "@/components/ranking-shared"
...
export function RankingPublicClient({
  ...
  // 공개 랭킹은 전적이 없는 선수(0승 0패)를 제외합니다
  const rankedPlayers = useMemo(
    () => computeRankedPlayers(members, allMatches, filterSeasonId, filterRace, filterTier, pastSeasonRankings, true),
