...
export default async function DataCenterPage() {
  const [{ members, matches, seasons }, headerData] = await Promise.all([
    fetchDataCenterInitialData(),
    fetchSiteHeaderData(),
  ])

  return <DataCenterPageClient members={members} matches={matches} seasons={seasons} headerData={headerData} />
}
